...
export function Home() {
  ...
  const [providers, setProviders] = useState<Record<Provider, boolean>>({ cc: false, codex: false, gemini: false, opencode: false, aider: false, hermes: false })
      ...
      header={
        <Box flexDirection="column">
          <Box>
            ...
            {(['cc', 'codex', 'gemini', 'opencode', 'aider', 'hermes'] as Provider[]).map(p => (
